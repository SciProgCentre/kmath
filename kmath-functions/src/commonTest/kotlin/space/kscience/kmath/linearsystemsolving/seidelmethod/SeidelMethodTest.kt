...
internal class SeidelMethodTest {
    ...
    fun positiveTest1() =
        Double.algebra.linearSpace.run {
            ...
            val result: Point<Double> = solveSystemBySeidelMethod(
                A = matrixA,
                B = vectorB,
    ...
    fun exceptionTest1() =
        Double.algebra.linearSpace.run {
            ...
            assertFails {
                solveSystemBySeidelMethod(matrixA, vectorB)
            }
    ...
    /**
     * Exception test,
     * WHEN matrix 'A' is 4x4 without the sufficient condition for the convergence of the Seidel method:
